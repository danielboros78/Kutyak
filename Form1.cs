  ...
  public partial class Form1 : Form
  {
    ...
    private void KutyakBeolvasasa()
    {
      ...
      while (!be.EndOfStream)
      {
        ...
        kutyak.Add(new Kutya(Convert.ToInt32(a[0]),Convert.ToInt32(a[1]),Convert.ToInt32(a[2]),Convert.ToInt32(a[3]),Convert.ToDateTime(a[4]),fajtak,kutyanevek));
      }
      be.Close();
    }
    ...
    private void NevekBeolvasasa()
    {
      ...
      {
        string[] a = be.ReadLine().Split(';');
        kutyanevek.Add(new Nev(Convert.ToInt32(a[0]), a[1]));
      }
      be.Close();
    }
    ...
    private void FajtakBeolvasasa()
    {
      ...
      {
        string[] a = be.ReadLine().Split(';');
        fajtak.Add(new Fajta(Convert.ToInt32(a[0]), a[1], a[2]));
      }
      be.Close();
    }
  }
